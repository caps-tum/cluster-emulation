...
echo "Dropping into n01 as mpiuser at /opt/hpc/build/ps"
#echo "Dropping into n01 as mpiuser at /opt/hpc/build/examples"
docker exec -it -u mpiuser -w  /opt/hpc/build/examples/ps --env COLUMNS=`tput cols` --env LINES=`tput lines` n01 bash
